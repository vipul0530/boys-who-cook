    ...
    <footer className="bg-gray-900 text-gray-400">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Brand */}
          <div>
            <p className="text-white font-semibold text-lg mb-2">{settings.site_name}</p>
            <p className="text-sm text-gray-500 leading-relaxed mb-5">{settings.tagline}</p>
            ...
            <div className="flex gap-3">
              ...
              {settings.twitter && (
                <SocialLink href={settings.twitter} label="Twitter / X">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              {settings.address && (
                <li className="whitespace-pre-line text-gray-500">{settings.address}</li>
              )}
            </ul>
          </div>
        </div>
